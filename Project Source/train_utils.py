...
def modify_net_prototxt(net_prototxt, new_net_prototxt, moving_average_fraction=0.9999):
...
def extract_minibatch_size_from_prototxt_with_input_layers(net_prototxt):
    net_param = caffe_pb2.NetParameter()
    with io.open(net_prototxt, 'r', encoding='utf-8') as f:
        txtf.Merge(str(f.read()), net_param)
...
# source_dir: source to the default NIC filelists
# target_dir: new dir for the aggregated filelist
